module player2_sprite_engine2 #(
    parameter ROM_FILE = "idle1.txt"
)(
    input  wire clk,
    ...
    localparam [4:0] LAST_X = WIDTH - 1;

    // Calculate local coordinates
    wire [15:0] lx = x - p_x;
    wire [15:0] ly = y - p_y;

    // Mirror the X coordinate when reading the ROM.
    wire [4:0] mirror_lx = LAST_X - lx[4:0];

    // Address for 32x64 = 2048 pixels
    wire [10:0] addr = {ly[5:0], mirror_lx};

    // ROM storage: 2048 addresses, 6 bits wide
